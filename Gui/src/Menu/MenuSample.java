    ...
    public static void main(String[] args) {
        ...
        Runnable runner = new Runnable() {
            public void run() {
                ...
                findOptionsMenu.setMnemonic(KeyEvent.VK_O); ButtonGroup directionGroup = new ButtonGroup(); 
                ...
                directionGroup.add(forwardMenuItem); JRadioButtonMenuItem backMenuItem = new JRadioButtonMenuItem("Back");
